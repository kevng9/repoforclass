...
export default class TTTBoard extends Component{
  ...
  checkBoard(){
    ...
    //rows
    if(this.state.board[0]==this.state.board[1] && this.state.board[1]==this.state.board[2] && this.state.board[0]!=0){return this.state.board[0]}
    if(this.state.board[3]==this.state.board[4] && this.state.board[4]==this.state.board[5] && this.state.board[3]!=0){return this.state.board[3]}
    if(this.state.board[6]==this.state.board[7] && this.state.board[7]==this.state.board[8] && this.state.board[6]!=0){return this.state.board[6]}
    //columns
    if(this.state.board[0]==this.state.board[3] && this.state.board[3]==this.state.board[6] && this.state.board[0]!=0){return this.state.board[0]}
    if(this.state.board[1]==this.state.board[4] && this.state.board[4]==this.state.board[7] && this.state.board[1]!=0){return this.state.board[1]}
    if(this.state.board[2]==this.state.board[5] && this.state.board[5]==this.state.board[8] && this.state.board[2]!=0){return this.state.board[2]}
    //diagonals
    if(this.state.board[0]==this.state.board[4] && this.state.board[4]==this.state.board[8] && this.state.board[0]!=0){return this.state.board[0]}
    if(this.state.board[2]==this.state.board[4] && this.state.board[4]==this.state.board[6] && this.state.board[2]!=0){return this.state.board[2]}
  ...
  selectCell(cell){
    ...
    this.setState({board:currentBoard}
     , ()=>{//console.log(this.state.board);
      ...
      console.log('individual board:',this.state);
